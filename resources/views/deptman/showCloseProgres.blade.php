    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('showHistoryCLaimComplain') }}">Menu Riwayat Klaim dan
                            Komplain</a></li>
                        ...
                        <form action="{{ route('updateConfirm', $handlings->id) }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="category_input"
                                                ...
                                                value="{{ $handlings->category }}" disabled>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                    ...
                                    <br>
                                    <div class="row" id="materialProjectRow" style="display: none;">
                                        <div class="col-lg-6">
                                            <label for="material_project" class="col-sm-5 col-form-label">Material
                                                Project<span style="color: red;">*</span></label>
                                        </div>
                                        <div class="col-lg-6">
                                            <select name="material_project" class="form-control" id="material_project"
                                                style="width: 100%;" disabled>
                                                <option value="">------------- Pilih Material Project ------------
                                                </option>
                                                <option value="Spectro"
                                                    {{ $handlings->process_type == 'Spectro' ? 'selected' : '' }}>
                                                    Spectro</option>
                                                <option value="Cutting"
                                                    {{ $handlings->process_type == 'Kekerasan' ? 'selected' : '' }}>
                                                    Kekerasan
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <tbody>
                                            @foreach ($data as $row)
                                                <tr>
                                                    ...
                                                    <td class="text-center py-3">
                                                        <!-- Kolom Catatan akan diisi oleh JavaScript -->
                                                    </td>
                                                    <td class="text-center py-3">
        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                const materialProjectRow = document.getElementById('material_project')?.parentElement?.parentElement;
                ...
                function updateUIBasedOnRequest(value) {
                    if (value === "Trial") {
                        ...
                        materialProjectRow.style.display = "flex";
                        ...
                        materialProjectRow.style.display = "none";
