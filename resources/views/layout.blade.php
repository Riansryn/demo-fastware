    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            @php
                ...
                $userRoles = [1, 14, 15, 50, 30, 40, 11]; // user Roles
                $finnRole = [1, 14, 11, 12]; // user Roles
                $procRoles = [1, 14, 41]; // user Roles
            @endphp
            <li class="nav-heading">Purchase Order</li>
                        ...
                        <ul id="approvalSubsectionPoPengajuanDeptHead" class="nav-content collapse"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('index.PO.procurement') }}">
                                    <i class="bi bi-check-circle fs-6"></i>
                                    <span>Persetujuan Pengajuan Form by Procurment Menu 1</span>
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul id="approvalSubsectionPoPengajuanDeptHead" class="nav-content collapse"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('index.PO.procurement2') }}">
                                    <i class="bi bi-check-circle fs-6"></i>
                                    <span>Persetujuan Pengajuan Form by Procurment Menu 2</span>
                                </a>
                            </li>
                        </ul>
                    @endif
