                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="row" id="materialProjectRow" style="display: none;">
                                        <div class="col-lg-6">
                                            <label for="material_project" class="col-sm-5 col-form-label">Identifikasi Material
                                        ...
                                        <div class="col-lg-6">
                                            <select name="material_project" class="form-control" id="material_project"
                                                ...
                                                <option value="Spectro"
                                                    {{ $handlings->material_project == 'Spectro' ? 'selected' : '' }}>
                                                    Spectro</option>
                                                <option value="Cutting"
                                                    {{ $handlings->material_project == 'Kekerasan' ? 'selected' : '' }}>
                                                    Kekerasan
                                                </option>
                                            </select>
                                        </div>
