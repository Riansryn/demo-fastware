                            ...
                            <div class="modal-body">
                                <form action="{{ route('approveKM') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="editJudul" name="judul" readonly>
                                    </div>
                                    <div class="mb-3">
                                        <label for="editKeterangan" class="form-label">Sinopsis Isi Buku</label>
                                        <textarea class="form-control" id="editKeterangan" name="keterangan" rows="4" readonly></textarea>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-10">
