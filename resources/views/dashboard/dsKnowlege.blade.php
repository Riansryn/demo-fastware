    ...
    <main id="main" class="main">
        <section class="section dashboard">
            <div class="row">
                ...
                {{-- <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">E-Announcement</h5>
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide custom-carousel" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    <img src="assets/img/slides-2.jpg" class="d-block w-100 custom-carousel-img"
                                        alt="...">
                                </div>
                                <div class="carousel-item">
                            ...
                            <div class="col-md-4" data-views="{{ $jumlahLihat }}" data-status="{{ $status }}">
                                <div class="card mb-4">
                                    <div class="card-body d-flex flex-column justify-content-between align-items-start">
                                        <div>
                                            <h5 class="card-title">
                                                {{ $pengajuan->judul }} - {{ $pengajuan->kmKategori->nama_kategori }} - <i
                                                    class="fas fa-eye"></i>
                                                ({{ $jumlahLihat }})
                                            </h5>
